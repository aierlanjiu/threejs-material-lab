...
scene.render.resolution_x=900;scene.render.resolution_y=1000;scene.cycles.samples=24
prefs=bpy.context.preferences.addons['cycles'].preferences
prefs.compute_device_type='METAL';prefs.get_devices()
for d in prefs.devices:d.use=d.type=='METAL'
scene.cycles.device='GPU'
for role,name,height,scale in [('hoodie','HoodieLychee',1.72,3.85),('astro','AstroLychee',2.13,4.72)]:
